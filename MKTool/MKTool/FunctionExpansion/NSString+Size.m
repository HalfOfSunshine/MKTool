...
- (CGFloat)heightForFont:(UIFont*)font maxWidth:(CGFloat)maxWidth{
     return ceil([self sizeForFont:font maxWidth:CGSizeMake(maxWidth, CGFLOAT_MAX)].height);
}

- (CGSize)sizeForFont:(UIFont*)font{
    return [self sizeForFont:font maxWidth:CGSizeMake(MK_ScreenSize.width, CGFLOAT_MAX)];
}

- (CGSize)sizeForFont:(UIFont*)font maxWidth:(CGSize)maxSize{
